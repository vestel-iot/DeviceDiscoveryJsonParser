...
//final class NewFDDiscoveryHandler: SettingDiscoveryHandler {
//    typealias OptionData = NewRefrigeratorData
//    
//    typealias GenericDeviceData = RefrigeratorDeviceData
//    
//    nonisolated(unsafe) static var shared = NewFDDiscoveryHandler()
//    
//    func getJson(
//        uuid: String,
